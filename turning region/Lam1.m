function Lambda1 = Lam1(averagek2,dE,dI,A,beta1,beta2,d,mu,gamma,averagek1)
...
c= 2*E1*I1*averagek2*beta2*A + 2*E1*I1*averagek2*beta2*d + I1^2*mu*beta2*averagek2 + 3*I1^2*averagek2*beta2*A + 2*I1^2*averagek2*beta2*d + E1*beta1*averagek1*A + E1*beta1*averagek1*d + I1*mu*beta1*averagek1 + 2*I1*beta1*averagek1*A + I1*beta1*averagek1*d - 2*I1*averagek2*beta2*A - 2*I1*averagek2*beta2*d - beta1*averagek1*A - beta1*averagek1*d + mu*A + mu*d + A*gamma + gamma*d;
